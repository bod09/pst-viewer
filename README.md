...
- **Settings** (the gear button, top right): read text in images on or off, load images from the internet on or off, show or hide empty folders, and the theme and accent colours.
...
- **Search shows the first 200 matches.** The heading says how many matched in total ("200 of 4,812"), so a capped list is never mistaken for the whole answer; narrow the search to see the rest.
